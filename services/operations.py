...
class OperationService:
    ...
    def _get_object_by_id(self, user_id: int, operation_id: int) -> tables.Operation:
        operation = (
            self.session
    ...
    def get_by_id(self, user_id: int, operation_id: int) -> tables.Operation:
        return self._get_object_by_id(user_id, operation_id)
    ...
    def update(self, user_id: int, operation_id: int, operation_data: OperationUpdate) -> tables.Operation:
        operation = self._get_object_by_id(user_id, operation_id)
